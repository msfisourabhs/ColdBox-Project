	...
	<td colspan="2">
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="width:500px;"><p style="margin:20px 20px 20px 20px;" class="loginCopyrightText"><admin:l10n id="copyright_cont">&copy; 1997-2012 Adobe Systems Incorporated and its licensors. All Rights Reserved. Adobe, the Adobe logo, and ColdFusion are either registered trademarks or trademarks of Adobe Systems Incorporated in the United States and/or other countries.</admin:l10n></p>
				</td>
			</tr>
		</table>
		<br />
